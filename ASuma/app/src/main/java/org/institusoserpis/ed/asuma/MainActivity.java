package org.institusoserpis.ed.asuma;
...
public class MainActivity extends AppCompatActivity {
    ...
    @Override
    protected void onCreate(Bundle savedInstanceState) { //Se ejecuta siempre al principio
    ...
    public void onButtonSumaClick(View view) {
        ...
        // String string1= editText1.getText().toString();
        // double decimal1 = Double.parseDouble(string1) ;
        // String string2 = editText2.getText().toString();
        //double decimal2 = Double.parseDouble(string2);
